        ...
        const actionButton = count === 0
            ? `
                <button onclick="addToCart(${service.id})" 
                    class="flex items-center px-3 py-2 text-sm font-medium text-green-700 bg-green-50 rounded-md hover:bg-green-100 transition">
                    <i data-lucide="plus-circle" class="w-4 h-4 mr-1.5"></i> Add Item
                </button>
              `
            : `
                <button onclick="removeFromCart(${service.id})" 
                    class="flex items-center px-3 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-md hover:bg-red-100 transition">
                    <i data-lucide="minus-circle" class="w-4 h-4 mr-1.5"></i> Remove Item
                </button>
              `;
